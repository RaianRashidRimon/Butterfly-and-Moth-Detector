...
data_path = fr'Enter the path to the dataset'
os.listdir(data_path)



base_name = 'butterfly_and_moth'
width = 80
 
include = {'VICEROY', 'ULYSES', 'SLEEPY ORANGE', 
           'ROSY MAPLE MOTH', 'CINNABAR MOTH', 'POPINJAY'} #more classes of butterfly and moth can be added here
